...
In drawing flow diagrams we will typically begin with a drawing a box (or some other pictorial representation) representing our system of interest. Then we will draw arrows going into or out of this box representing the initial contents or streams/pipes/flows of mass or energy that go into or out of the system. 
